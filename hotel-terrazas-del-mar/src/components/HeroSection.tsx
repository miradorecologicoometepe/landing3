...
export const HeroSection: React.FC<HeroSectionProps> = ({ onExploreRooms, onOpenGallery, onOpenBookingModal, hotelConfig }) => (
  <section className="relative isolate min-h-[88svh] lg:min-h-screen overflow-hidden bg-[#087f83] text-white flex items-center">
    ...
    <div className="w-full max-w-7xl mx-auto px-6 sm:px-10 lg:px-14 pt-36 pb-28 sm:pt-44 sm:pb-36">
      <div className="max-w-3xl">
        ...
        <h1 className="font-serif text-[clamp(2.8rem,5.7vw,5.5rem)] leading-[1.08] tracking-tight font-medium max-w-3xl mb-10">Donde la <em className="text-[#b6f2e6]">naturaleza</em> se abraza con el lago y los volcanes</h1>
        ...
        <div className="flex flex-wrap items-center gap-5 sm:gap-8">
          <button onClick={onExploreRooms} className="rounded-full bg-[#b6f2e6] hover:bg-[#d1fff3] text-[#075c63] px-8 py-4 font-bold inline-flex items-center gap-3 shadow-lg transition-colors">Ver habitaciones <ArrowRight className="w-5 h-5" /></button>
